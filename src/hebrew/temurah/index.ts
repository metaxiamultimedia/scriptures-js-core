 ...
 * - Atbash: Jewish Encyclopedia (1906) + Pardes Rimonim (1548)
 ...
 *
 * Sources:
 * - Jewish Encyclopedia (1906), "Gematria", Section II.2, p.589
...
export const CIPHERS: Record<string, CipherSystem> = {
  atbash: {
    ...
    source: {
      text: 'Jewish Encyclopedia (1906) + Pardes Rimonim (1548)',
